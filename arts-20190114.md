...
1.Leader和Boss的不同 
  Boss的领导力则来自于职位和震慑, Leader的领导力来自于大家自发的跟随；
  Boss驱动员工, Leader指导员工；
  Boss制造畏惧, Leader制造热情；
  Boss在面对错误的时候喜欢使用人士惩罚手段,Leader在面对错误的时候喜欢寻找解决问题的技术和管理方法；
  Boss只知道怎么做, Leader展示怎么做；
  Boss用人, Leader发展人；
  Boss从团队收割成绩, Leader给予团队成绩；
  Boss喜欢命令和控制, Leader喜欢沟通和协作；
