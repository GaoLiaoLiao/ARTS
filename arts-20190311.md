...
Hotspot虚拟机的对象头主要包括两部分内容：
  ...
  2. Class对象的地址, JVM通过这个指针判断对象是哪个类的对象。
...
### References
  ...
  5. [JVM内部细节之一：synchronized关键字及实现细节（轻量级锁Lightweight Locking）](www.cnblogs.com/javaminer/p/3889023.html)
  6. [实例分析JAVA CLASS的文件结构](https://coolshell.cn/articles/9229.html)
