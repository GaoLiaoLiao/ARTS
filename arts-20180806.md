...
### 3. Tip
This week, I picked up some knowledge of python decorator following [this article](https://stackoverflow.com/questions/739654/how-to-make-a-chain-of-function-decorators). Another article worth reading on this topic written by Chen Hao can be found on his tech blog [Coolshell](https://coolshell.cn/articles/11265.html), in which you can find some cool examples of the usage of python decorator.
    Also I found that I don't know what star operator '*' means in python, so I found some answers on stackoverlfow:
    When reading the two articles above, I found I don't understand what '*args' and '**kwargs' mean, which are mentioned in both of the two articles. So 
    I found some discussion on stackoverflow.
